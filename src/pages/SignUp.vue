      ...
      <div class="bg-white w-2/6 h-4/5 p-20 rounded-3xl">
        ...
        <div class="flex flex-col items-center justify-center space-y-4">
            <div class="flex gap-5">
                <button @click="signUp" type="submit"class="text-white bg-emerald-400 text-black text-xl font-medium px-14 py-4 rounded-full hover:bg-emerald-500 transition mb-4">Sing up</button>
                <router-link to="/">
