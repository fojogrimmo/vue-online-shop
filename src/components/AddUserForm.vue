...
<template>
  <div class="bg-gray-800 p-10 rounded-lg shadow-md z-50">
    ...
    <form @submit.prevent="submitForm">
      ...
      <button
        type="submit"
        class="bg-emerald-400 text-black text-xl font-medium px-4 py-2 rounded hover:bg-emerald-500 transition"
      >
        Add User
      </button>
    </form>
